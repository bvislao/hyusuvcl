...
(0, globals_1.describe)('Query generator', function () {
    ...
    (0, globals_1.it)('generates a resolver with optional input', function () {
        index_1.g.query('greet', {
            args: { name: index_1.g.string().optional() },
            returns: index_1.g.string(),
            resolver: 'hello'
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"extend type Query {\n        greet(name: String): String! @resolver(name: \"hello\")\n      }\"\n    ");
    ...
    (0, globals_1.it)('generates a resolver with input default value', function () {
        index_1.g.query('greet', {
            args: { name: index_1.g.string().default('Bob') },
            returns: index_1.g.string(),
            resolver: 'hello'
        });
    ...
    (0, globals_1.it)('generates a resolver with optional input and output', function () {
        index_1.g.query('greet', {
            args: { name: index_1.g.string().optional() },
            returns: index_1.g.string().optional(),
            resolver: 'hello'
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"extend type Query {\n        greet(name: String): String @resolver(name: \"hello\")\n      }\"\n    ");
    });
    (0, globals_1.it)('generates a resolver with list input', function () {
        index_1.g.query('greet', {
            args: { name: index_1.g.string().list() },
            returns: index_1.g.string(),
            resolver: 'hello'
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"extend type Query {\n        greet(name: [String!]!): String! @resolver(name: \"hello\")\n      }\"\n    ");
    ...
    (0, globals_1.it)('generates a mutation resolver with required input and output', function () {
        var input = index_1.g.input('CheckoutSessionInput', { name: index_1.g.string() });
        var output = index_1.g.type('CheckoutSessionOutput', { successful: index_1.g.boolean() });
        index_1.g.mutation('checkout', {
            args: { input: index_1.g.inputRef(input) },
            returns: index_1.g.ref(output),
            resolver: 'checkout'
        });
    ...
    (0, globals_1.it)('generates a mutation resolver with enum input and output', function () {
        var output = index_1.g.type('CheckoutSessionOutput', { successful: index_1.g.boolean() });
        var enm = index_1.g.enum('Foo', ['A', 'B']);
        index_1.g.mutation('checkout', {
            args: { input: index_1.g.enumRef(enm) },
            returns: index_1.g.ref(output),
            resolver: 'checkout'
        });
    ...
    (0, globals_1.it)('generates a query as part of the full SDL', function () {
        var enm = index_1.g.enum('Foo', ['Bar', 'Baz']);
        index_1.g.query('greet', {
            args: { name: index_1.g.string() },
            returns: index_1.g.string().list(),
            resolver: 'hello'
        });
        index_1.g.query('sweet', {
            args: { game: index_1.g.int().optional() },
            returns: index_1.g.enumRef(enm).list(),
            resolver: 'jello'
        });
    ...
    (0, globals_1.it)('prevents using of whitespaced identifier as the name', function () {
        (0, globals_1.expect)(function () {
            return index_1.g.query('white space', {
                args: { name: index_1.g.string() },
                returns: index_1.g.string(),
                resolver: 'hello'
            });
    ...
    (0, globals_1.it)('prevents using of whitespaced identifier an argument name', function () {
        (0, globals_1.expect)(function () {
            return index_1.g.query('Test', {
                args: { 'white space': index_1.g.string() },
                returns: index_1.g.string(),
                resolver: 'hello'
            });
        }).toThrow('Given name "white space" is not a valid TypeScript identifier.');
    ...
    (0, globals_1.it)('generates an input type with an enum field', function () {
        var color = index_1.g.enum('Color', ['Red', 'Green', 'Blue']);
        index_1.g.input('Data', {
            color: index_1.g.enumRef(color).optional()
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"enum Color {\n        Red,\n        Green,\n        Blue\n      }\n\n      input Data {\n        color: Color\n      }\"\n    ");
    });
    (0, globals_1.it)('generates an input type with a list field', function () {
        index_1.g.input('Data', {
            color: index_1.g.int().list()
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"input Data {\n        color: [Int!]!\n      }\"\n    ");
    });
    (0, globals_1.it)('generates an input type with a nested input field', function () {
        var nested = index_1.g.input('Nested', {
            x: index_1.g.boolean()
        });
        index_1.g.input('Data', {
            color: index_1.g.inputRef(nested)
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"input Nested {\n        x: Boolean!\n      }\n\n      input Data {\n        color: Nested!\n      }\"\n    ");
    });
    (0, globals_1.it)('generates an input type with a nested list input field', function () {
        ...
        index_1.g.input('Data', {
            color: index_1.g.inputRef(nested).list()
        });
        (0, globals_1.expect)((0, utils_1.renderGraphQL)((0, index_1.config)({ schema: index_1.g }))).toMatchInlineSnapshot("\n      \"input Nested {\n        x: Boolean!\n      }\n\n      input Data {\n        color: [Nested!]!\n      }\"\n    ");
    });
});
